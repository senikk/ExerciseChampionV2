(function () {
  ...
  goog.inherits(proto.rehearsal.AddRehearsalResponse, googleProtobuf.Message);
  if (goog.DEBUG && !COMPILED) {
    /**
     * @public
     * @override
  ...
  goog.inherits(proto.rehearsal.SearchContestRequest, googleProtobuf.Message);
  if (goog.DEBUG && !COMPILED) {
    /**
     * @public
     * @override
  ...
  proto.rehearsal.AddRehearsalRequest.toObject = function(includeInstance, msg) {
    var obj = {
      ...
      minutes: googleProtobuf.Message.getFieldWithDefault(msg, 3, 0),
      description: googleProtobuf.Message.getFieldWithDefault(msg, 4, "")
    };
  ...
  proto.rehearsal.AddRehearsalResponse.toObject = function(includeInstance, msg) {
    var obj = {
      result: googleProtobuf.Message.getFieldWithDefault(msg, 1, 0)
    };
  ...
  */
  ...
  proto.rehearsal.RemoveRehearsalRequest.toObject = function(includeInstance, msg) {
    var obj = {
      userid: googleProtobuf.Message.getFieldWithDefault(msg, 1, 0),
      rehearselid: googleProtobuf.Message.getFieldWithDefault(msg, 2, 0)
    };
  ...
  */
  ...
  proto.rehearsal.SearchContestRequest.toObject = function(includeInstance, msg) {
    var obj = {
      search: googleProtobuf.Message.getFieldWithDefault(msg, 1, "")
    };
  ...
  proto.rehearsal.Result.toObject = function(includeInstance, msg) {
    var obj = {
      ...
      minutes: googleProtobuf.Message.getFieldWithDefault(msg, 5, "")
    };
  ...
  */
  ...
  const methodDescriptor_Rehearsal_AddRehearsal = new grpc.web.MethodDescriptor(
    ...
    proto$1.rehearsal.AddRehearsalResponse,
    /**
    ...
    proto$1.rehearsal.AddRehearsalResponse.deserializeBinary
  );
  ...
  const methodDescriptor_Rehearsal_AddContest = new grpc.web.MethodDescriptor(
    ...
    proto$1.rehearsal.AddContestResponse,
    /**
    ...
    proto$1.rehearsal.AddContestResponse.deserializeBinary
  );
  ...
  const methodDescriptor_Rehearsal_SearchContest = new grpc.web.MethodDescriptor(
    ...
    grpc.web.MethodType.UNARY,
    proto$1.rehearsal.SearchContestRequest,
    proto$1.rehearsal.ListContestReponse,
    /**
   ...
   *     The XHR Node Readable Stream
   */
  proto$1.rehearsal.RehearsalClient.prototype.searchContest =
      function(request, metadata, callback) {
    return this.client_.rpcCall(this.hostname_ +
        '/rehearsal.Rehearsal/SearchContest',
        request,
   ...
   *     A native promise that resolves to the response
   */
  proto$1.rehearsal.RehearsalPromiseClient.prototype.searchContest =
      function(request, metadata) {
    return this.client_.unaryCall(this.hostname_ +
        '/rehearsal.Rehearsal/SearchContest',
        request,
  ...
  var Helper = {
    ...
    auth: new Auth(),
    rehearsal: new rehearsal_grpc_web_pb_1("http://localhost:8080"),
    requests: requests
  };
