<selectperiod>
    <div class="input-field">
        <select ref="period">
            ...
            <option value={this.R.ListResultRequest.Period.THISWEEK} selected={opts.chosen == this.R.ListResultRequest.Period.THISWEEK}>{ i18n.t('period.thisweek', {week: moment().week()-1}) }</option>
            <option value={this.R.ListResultRequest.Period.LASTWEEK} selected={opts.chosen == this.R.ListResultRequest.Period.LASTWEEK}>{ i18n.t('period.lastweek', {week: moment().add(-1,'week').week()-1}) }</option>
